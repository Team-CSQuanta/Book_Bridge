            ...
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    ...
                    <div class="banner-text d-md-block d-none">
                        ...
                        <a href="shop-grid-right.php" class="btn">Learn More <i class="fi-rs-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
...
<i class="fi-rs-eye"></i></a>
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="shop-product-right.php">Aliquam posuere</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
...
<i class="fi-rs-eye"></i></a>
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="shop-product-right.php">Sed dapibus orci</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
...
<i class="fi-rs-eye"></i></a>
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="shop-product-right.php">Donec congue</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
...
<i class="fi-rs-eye"></i></a>
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="shop-product-right.php">Curabitur porta</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
...
<i class="fi-rs-eye"></i></a>
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="shop-product-right.php">Praesent maximus</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
...
<i class="fi-rs-eye"></i></a>
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="shop-product-right.php">Vestibulum ante</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
                    ...
                    <div class="col-lg-6 deal-co">
                        <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0" style="background-image: url('assets/imgs/banner/menu-banner-7.jpg');">
                            ...
                            <div class="deal-content">
                                <h6 class="product-title"><a href="shop-product-right.php">Summer Collection New Morden Design</a></h6>
                                <div class="product-price"><span class="new-price">$139.00</span><span class="old-price">$160.99</span></div>
                            </div>
                            <div class="deal-bottom">
                                <p>Hurry Up! Offer End In:</p>
                                <div class="deals-countdown" data-countdown="2025/03/25 00:00:00"></div>
                                <a href="shop-grid-right.php" class="btn hover-up">Shop Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 deal-co">
                        <div class="deal wow fadeIn animated" style="background-image: url('assets/imgs/banner/menu-banner-8.jpg');">
                            ...
                            <div class="deal-content">
                                <h6 class="product-title"><a href="shop-product-right.php">Try something new on vacation</a></h6>
                    ...
                    <div class="col-lg-3 d-none d-lg-flex">
                        <div class="banner-img style-2 wow fadeIn animated">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="shop-grid-right.php" class="text-white">Shop Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <a href="shop-grid-right.php">Nulla</a>
                                                </div>
                                                <h2><a href="shop-product-right.php">Maecenas eget</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <a href="shop-grid-right.php">Duis </a>
                                                </div>
                                                <h2><a href="shop-product-right.php">Luctus suscipit</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <a href="shop-grid-right.php">Fusce </a>
                                                </div>
                                                <h2><a href="shop-product-right.php">Aliquam ac</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <a href="shop-grid-right.php">Nunc </a>
                                                </div>
                                                <h2><a href="shop-product-right.php">Fusce et ligula</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <a href="shop-grid-right.php">Aliquam</a>
                                                </div>
                                                <h2><a href="shop-product-right.php">Morbi lacinia</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href="shop-product-right.php">Cotton Leaf Printed 2</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href="shop-product-right.php">Smart Speaker</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
...
<i class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a href="shop-product-right.php">Hugy Speaker</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span>
                                                        <span>70%</span>
                                                    </span>
                        ...
                        <div class="post-list mb-4 mb-lg-0">
                            <article class="wow fadeIn animated">
                                <div class="d-md-flex d-block">
                                    <div class="post-thumb d-flex mr-15">
                                        <a class="color-white" href="blog-post-fullwidth.php">
                                            <img src="assets/imgs/blog/blog-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                        <div class="entry-meta mb-10 mt-10">
                                            <a class="entry-meta meta-2" href="blog-category-fullwidth.php"><span class="post-in font-x-small">Fashion</span></a>
                                        </div>
                                        <h4 class="post-title mb-25 text-limit-2-row">
                                            <a href="blog-post-fullwidth.php">Qualcomm is developing a Nintendo Switch-like console, report says</a>
                                        </h4>
                            ...
                            <article class="wow fadeIn animated">
                                <div class="d-md-flex d-block">
                                    ...
                                    <div class="post-content">
                                        <div class="entry-meta mb-10 mt-10">
                                            <a class="entry-meta meta-2" href="blog-category-fullwidth.php"><span class="post-in font-x-small">Healthy</span></a>
                                        </div>
                                        <h4 class="post-title mb-25 text-limit-2-row">
                                            <a href="blog-post-fullwidth.php">Not even the coronavirus can derail 5G's global momentum</a>
                                        </h4>
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            <div>
                                                <span class="post-on">14 April 2022</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
                        ...
                        <div class="product-list-small wow fadeIn animated">
                            <article class="row align-items-center">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Fish Print Patched T-shirt</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                            ...
                            <article class="row align-items-center">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Vintage Floral Print Dress</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                            ...
                            <article class="row align-items-center">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Multi-color Stripe Circle Print T-Shirt</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                    ...
                    <div class="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
                        ...
                        <div class="product-list-small wow fadeIn animated">
                            <article class="row align-items-center">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Geometric Printed Long Sleeve Blosue</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                            ...
                            <article class="row align-items-center">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.php"><img src="assets/imgs/shop/thumbnail-7.jpg" alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Print Patchwork Maxi Dress</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                            ...
                            <article class="row align-items-center">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.php"><img src="assets/imgs/shop/thumbnail-8.jpg" alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Daisy Floral Print Straps Jumpsuit</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="product-list-small wow fadeIn animated">
                            <article class="row align-items-center">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.php"><img src="assets/imgs/shop/thumbnail-9.jpg" alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Floral Print Casual Cotton Dress</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                            ...
                            <article class="row align-items-center">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Ruffled Solid Long Sleeve Blouse</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
                            ...
                            <article class="row align-items-center">
                                ...
                                <div class="col-md-8 mb-0">
                                    <h4 class="title-small">
                                        <a href="shop-product-right.php">Multi-color Print V-neck T-Shirt</a>
                                    </h4>
                                    <div class="product-price">
                                        <span>$238.85 </span>
                                        <span class="old-price">$245.8</span>
