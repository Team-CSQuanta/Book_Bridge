                                ...
                                <tbody>
                                    ...
                                    <tr class="pr_title">
                                        ...
                                        <td class="product_name">
                                            <h5><a href="shop-product-full.php">J.Crew Mercantile Women's Short</a></h5>
                                        </td>
                                        <td class="product_name">
                                            <h5><a href="shop-product-full.php">Amazon Essentials Women's Tanks</a></h5>
                                        </td>
                                        <td class="product_name">
                                            <h5><a href="shop-product-full.php">Amazon Brand - Daily Ritual Wom</a></h5>
                                        </td>
                                    </tr>
                                    <tr class="pr_price">
                                    ...
                                    <tr class="pr_stock">
                                        ...
                                        <td class="row_stock"><span>In Stock</span></td>
                                        <td class="row_stock"><span class="text-danger font-weight-bold">Out of stock</span></td>
                                        <td class="row_stock"><span>In Stock</span></td>
                                    </tr>
                                    <tr class="pr_weight">
                                    ...
                                    <tr class="pr_add_to_cart">
                                        ...
                                        <td class="row_btn"> <button class="btn  btn-sm btn-secondary"><i class="fi-rs-headset mr-5"></i>Contact Us</button></td>
                                        <td class="row_btn"><button class="btn  btn-sm"><i class="fi-rs-shopping-bag mr-5"></i>Add to cart</button></td>
                                    </tr>
