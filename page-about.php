            ...
            <div class="container">
                <div class="row mb-50">
                    <div class="col-lg-12 col-md-12 text-center">
                        <h6 class="mt-0 mb-5 text-uppercase  text-brand font-sm wow fadeIn animated">BookBridge Coporation</h6>
                ...
                <div class="row">
                    <div class="col-md-4 text-center mb-md-0 mb-4">
                        ...
                        <h4 class="mt-30 mb-15 wow fadeIn animated">Dhaka, BD</h4>
                        <p class="text-grey-3 wow fadeIn animated">United International University,United City,<br> Madani Ave, Dhaka 1212</p>
                    </div>
                    <div class="col-md-4 text-center mb-md-0 mb-4">
