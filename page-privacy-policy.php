                    ...
                    <div class="col-lg-9">
                        <div class="single-page pr-30">
                            ...
                            <div class="single-content">
                                <h4>Welcome to BookBridge’s Privacy Policy</h4>
                                <ol start="1">
                                    <li>Hi there, we’re BookBridge Pty Ltd (ABN 11 119 159 741) of Level 1, 121 King Street Melbourne, 3000, Australia (“<strong>BookBridge</strong>”) and welcome to our privacy policy which also applies to our Affiliate Companies. This policy sets out how we handle your personal information if you’re an BookBridge user or visitor to our Sites. It applies across BookBridge Elements, BookBridge Market, BookBridge Twenty20, BookBridge Studio, BookBridge Sites, BookBridge Tuts+ and Placeit (the “<strong>Sites</strong>”).</li>
                                    <li>When we say ‘we’, ‘us’ or ‘BookBridge’ it’s because that’s who we are and we own and run the Sites.</li>
                                ...
                                <ol start="6">
                                    ...
                                    <li>As the operator of digital content marketplaces, we have a legitimate interest in verifying the identity of our authors. We believe that knowing who our authors are will strengthen the integrity of our marketplaces by reducing fraud, making authors more accountable for their content and giving BookBridge and customers the ability to enforce contracts for authors who break the rules. BookBridge also has certain legal obligations that require us to know who our authors are in certain circumstances. In light of this, if you are an author we will verify your identity, in particular, your name, full address and date of birth by asking you to show us a Photo ID document. The verification procedure is called BookBridge Verify. BookBridge Verify will be carried out by our service provider Jumio Corporation located at 395 Page Mill Road, Suite 150, Palo Alto, California, USA. As part of BookBridge Verify, you will be asked to take a selfie which will then be compared against your Photo ID document using facial recognition technology. We will use your Photo ID document solely to carry out BookBridge Verify and delete it after the completion of this process.</li>
                                </ol>
                                ...
                                <ol start="10">
                                    <li>We will use your personal information:<ol>
                                            ...
                                            <li>Where this is necessary for purposes which are in our, or third parties’, legitimate interests. These interests include:<ol>
                                                    ...
                                                    <li>training BookBridge staff about how to best serve our user community;</li>
                                                    ...
                                                    <li>processing your job application to BookBridge.</li>
                                                </ol>
                                            </li>
                                ...
                                <ol start="11">
                                    <li>We will disclose personal information to the following recipients:<ol>
                                            <li>companies that are in the BookBridge group which are located in Australia, Mexico and the US;</li>
                                ...
                                <ol start="17">
                                    <li>For more information about how we use cookies, web beacons and similar technologies see our cookie policy <a href="https://BookBridge.com/cookies/">here</a> and for more general information on cookies, see <a href="http://www.allaboutcookies.org/" rel="noopener noreferrer">http://www.allaboutcookies.org</a>.</li>
                                ...
                                <ol start="25">
                                    <li>If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy champion in writing at PO Box 16122 Collins Street West Victoria 8007 Australia or <a href="mailto:privacy.champion@BookBridge.com">privacy.champion@BookBridge.com</a>.</li>
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget_categories mb-40">
                                ...
                                <div class="post-block-list post-module-1 post-module-5">
                                    <ul>
                                        <li class="cat-item cat-item-2"><a href="blog-category-list.php">Beauty</a> (3)</li>
                                        <li class="cat-item cat-item-3"><a href="blog-category-list.php">Book</a> (6)</li>
                                        <li class="cat-item cat-item-4"><a href="blog-category-list.php">Design</a> (4)</li>
                                        <li class="cat-item cat-item-5"><a href="blog-category-list.php">Fashion</a> (3)</li>
                                        <li class="cat-item cat-item-6"><a href="blog-category-list.php">Lifestyle</a> (6)</li>
                                        <li class="cat-item cat-item-7"><a href="blog-category-list.php">Travel</a> (2)</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-widget widget_tags mb-50">
                                ...
                                <div class="tagcloud">
                                    <a class="tag-cloud-link" href="blog-category-grid.php">beautiful</a>
                                    <a class="tag-cloud-link" href="blog-category-grid.php">New York</a>
                                    <a class="tag-cloud-link" href="blog-category-grid.php">droll</a>
                                    <a class="tag-cloud-link" href="blog-category-grid.php">intimate</a>
                                    <a class="tag-cloud-link" href="blog-category-grid.php">loving</a>
                                    <a class="tag-cloud-link" href="blog-category-grid.php">travel</a>
                                    <a class="tag-cloud-link" href="blog-category-grid.php">fighting </a>
                                </div>
                            </div>
                        </div>
                    </div>
